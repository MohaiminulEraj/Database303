        ...
        <body>
        	<div class="container">
        		<div style="padding-top: 30%; text-align: center;">
        			<h1>Case Study: Admission Interest Data Analysis</h1>
					<h2>Independent University, Bangladesh (IUB)</h2>
					<h3>Focus Year: <?php echo "$focus" ?></h3>
					<h3>Period: <?php echo "$start -$end" ?><h3>
					<h3>Data Source: IRAS, Students appeared for the summer admission tests</h3>
<br><br><br><br>
    			</div>
...
<p style="page-break-before: always">
    ...
    <?php
    \koolreport\widgets\google\PieChart::create(array(
        "title"=>$focus." School wise Distribution",
...
<p style="page-break-before: always">
    ...
    <?php
    \koolreport\widgets\google\PieChart::create(array(
        "title"=>$focus." @ SESM+Pharmacy Majors",
