...
class Datareport extends \koolreport\KoolReport
{
    ...
    $end = $_POST['end'];
        ...
        ->query("
            ...
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND em.year ='2019' AND
        ...
        ->query("
            ...
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MACN'
            GROUP BY em.year) AS tb1,
            (SELECT em.year, sum(em.noOfStudent)  AS IUB_MFIN
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MFIN'
            GROUP BY em.year) AS tb2,
            (SELECT em.year, sum(em.noOfStudent)  AS IUB_MMGT
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MMGT'
            GROUP BY em.year) AS tb3,
            (SELECT em.year, sum(em.noOfStudent) AS IUB_MHRM
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MHRM'
            GROUP BY em.year) AS tb4,
            (SELECT em.year,sum(em.noOfStudent) AS IUB_MINB
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MINB'
            GROUP BY em.year) AS tb5,
            (SELECT em.year, sum(em.noOfStudent) AS IUB_MIVM
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MIVM'
            GROUP BY em.year) AS tb6,
            (SELECT em.year, sum(em.noOfStudent) AS IUB_MMIS
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MMIS'
            GROUP BY em.year) AS tb7,
            (SELECT em.year, sum(em.noOfStudent) AS IUB_MMKT
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MMKT'
            GROUP BY em.year) AS tb8,
            (SELECT em.year, sum(em.noOfStudent) AS IUB_MECN
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year='2019' AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MECN'
        ...
        ->query("
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND em.majorID='IUB_MACN'
            GROUP BY em.year) as tb1,
            (SELECT em.year, SUM(em.noOfStudent) AS FIN
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSOB' AND em.majorID='IUB_MFIN'
            GROUP BY em.year) as tb2, 
            (SELECT em.year, SUM(em.noOfStudent) AS MGT
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MMGT'
            GROUP BY em.year) as tb3, 
            (SELECT em.year, SUM(em.noOfStudent) AS HRM
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MHRM'
            GROUP BY em.year) as tb4,
            (SELECT em.year, SUM(em.noOfStudent) AS INB
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MINB'
            GROUP BY em.year) as tb5,
            (SELECT em.year, SUM(em.noOfStudent) AS IVM
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MIVM'
            GROUP BY em.year) as tb6,
            (SELECT em.year, SUM(em.noOfStudent) AS MIS
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MMIS'
            GROUP BY em.year) as tb7,
            (SELECT em.year, SUM(em.noOfStudent) AS MKT
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MMKT'
            GROUP BY em.year) as tb8,
            (SELECT em.year, SUM(em.noOfStudent) AS ECN
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSOB' AND m.majorID='IUB_MECN'
            GROUP BY em.year) as tb9,
            tbl_exam_major em
            WHERE tb1.year = tb2.year AND tb2.year = tb3.year AND tb3.year=tb4.year AND tb4.year=tb5.year AND tb5.year=tb6.year AND tb6.year=tb7.year AND tb7.year=tb8.year AND tb8.year=tb9.year
            GROUP BY tb1.year
        ...
        ->query("
            ...
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND em.year='2019' AND  s.schoolID='IUB_SHSOB'
            GROUP BY em.semester
        ...
        ->query("
            ...
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND em.year>'2013' AND em.semester='Spring' AND s.schoolID='IUB_SHSOB'
            GROUP BY em.year) as tb1,
            (SELECT em.year, SUM(em.noOfStudent) AS Summer
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND em.year>'2013' AND em.semester='Summer' AND s.schoolID='IUB_SHSOB'
            GROUP BY em.year) as tb2, 
            (SELECT em.year, SUM(em.noOfStudent) AS Autumn
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND em.year>'2013' AND em.semester='Autumn' AND s.schoolID='IUB_SHSOB'
        ...
        ->query("
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSECS' AND em.majorID='IUB_MCEN'
            GROUP BY em.year) as tb1,
            (SELECT em.year, SUM(em.noOfStudent) AS IUB_MCSC
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSECS' AND em.majorID='IUB_MCSC'
            GROUP BY em.year) as tb2, 
            (SELECT em.year, SUM(em.noOfStudent) AS IUB_MCSE
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSECS' AND m.majorID='IUB_MCSE'
            GROUP BY em.year) as tb3, 
            (SELECT em.year, SUM(em.noOfStudent) AS IUB_MEEE
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSECS' AND m.majorID='IUB_MEEE'
            GROUP BY em.year) as tb4,
            (SELECT em.year, SUM(em.noOfStudent) AS IUB_METE
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSECS' AND m.majorID='IUB_METE'
            GROUP BY em.year) as tb5,
            (SELECT em.year, SUM(em.noOfStudent) AS IUB_MMAT
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSECS' AND m.majorID='IUB_MMAT'
            GROUP BY em.year) as tb6,
            (SELECT em.year, SUM(em.noOfStudent) AS IUB_MPHY
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2012' AND s.schoolID='IUB_SHSECS' AND m.majorID='IUB_MPHY'
            GROUP BY em.year) as tb7,
            tbl_exam_major em
        ...
        ->query("
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSECS' AND d.deptID='IUB_DCSE'
            GROUP BY em.year) as tb1,
            (SELECT em.year, SUM(em.noOfStudent) AS EEE
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSECS' AND d.deptID='IUB_DEEE'
            GROUP BY em.year) as tb2, 
            (SELECT em.year, SUM(em.noOfStudent) AS PS
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSECS' AND d.deptID='IUB_DPHYSCI'
            GROUP BY em.year) as tb3, tbl_exam_major em
            where tb1.year = tb2.year and tb2.year = tb3.year
            GROUP BY tb1.year
        ")
        ...
        ->query("
            ...
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND em.year='2019' AND  s.schoolID='IUB_SHSECS'
        ...
        ->query("
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DENG' AND em.majorID='IUB_MELT' 
            GROUP BY em.year) as tb1,
            (SELECT em.year, SUM(em.noOfStudent) AS ENG
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DENG' AND em.majorID='IUB_MENG'
            GROUP BY em.year) as tb2, 
            (SELECT em.year, SUM(em.noOfStudent) AS ANT
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DSOC' AND m.majorID='IUB_MANT'
            GROUP BY em.year) as tb3, 
            (SELECT em.year, SUM(em.noOfStudent) AS GSG
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DGSG' AND m.majorID='IUB_MGSG'
            GROUP BY em.year) as tb4,
            (SELECT em.year, SUM(em.noOfStudent) AS CMN
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DMED' AND m.majorID='IUB_MCMN'
            GROUP BY em.year) as tb5,
            (SELECT em.year, SUM(em.noOfStudent) AS SOC
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DSOC' AND m.majorID='IUB_MSOC'
            GROUP BY em.year) as tb6,
            (SELECT em.year, SUM(em.noOfStudent) AS LLB
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DLAW' AND m.majorID='IUB_MLLB'
            GROUP BY em.year) as tb7,
            tbl_exam_major em
            WHERE tb1.year = tb2.year AND tb2.year = tb3.year AND tb3.year=tb4.year AND tb4.year=tb5.year AND tb5.year=tb6.year AND tb6.year=tb7.year
            GROUP BY tb1.year        
        ...
        ->query("
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DENG'
            GROUP BY em.year) as tb1,
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DGSG'
            GROUP BY em.year) as tb2, 
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DLAW'
            GROUP BY em.year) as tb3,
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DMED'
            GROUP BY em.year) as tb4, 
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013' AND s.schoolID='IUB_SHSLASS' AND d.deptID='IUB_DSOC'
            GROUP BY em.year) as tb5, 
        ...
        ->query("
            SELECT m.majorName, sum(em.noOfStudent) AS 'Total Student'
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND em.year='2019' AND  s.schoolID='IUB_SHSLASS'
            GROUP BY m.majorName
        ")
        ...
        ->query("
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSESM' AND d.deptID='IUB_DPHAR' AND m.majorID='IUB_MPHA'
            GROUP BY em.year) as tb1,
            (SELECT em.year, SUM(em.noOfStudent) AS ENM
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSESM' AND d.deptID='IUB_DESC' AND m.majorID='IUB_MENM'
            GROUP BY em.year) as tb2, 
            (SELECT em.year, SUM(em.noOfStudent) AS ENV
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSESM' AND d.deptID='IUB_DESC' AND m.majorID='IUB_MENV'
            GROUP BY em.year) as tb3,
            (SELECT em.year, SUM(em.noOfStudent) AS POP
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSESM' AND d.deptID='IUB_DPOP' AND m.majorID='IUB_MPOP'
            GROUP BY em.year) as tb4,
            tbl_exam_major em
        ...
        ->query("
            SELECT em.semester, sum(em.noOfStudent) AS 'Total Student'
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND em.year='2019' AND  s.schoolID='IUB_SHSESM'
            GROUP BY em.semester
        ...
        ->query("
            SELECT m.majorName, sum(em.noOfStudent) AS 'Total Student'
            FROM tbl_exam_major em, tbl_exam e, tbl_school s, tbl_major m, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND e.year=em.year AND e.semester=em.semester AND e.slot=em.slot AND em.year='2019' AND  s.schoolID='IUB_SHSLS'
            GROUP BY m.majorName
        ")
        ...
        ->query("
            ...
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSLS' AND d.deptID='IUB_DSLS' AND m.majorID='IUB_MBIO'
            GROUP BY em.year) as tb1,
            (SELECT em.year, SUM(em.noOfStudent) AS BIT
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSLS' AND d.deptID='IUB_DSLS' AND m.majorID='IUB_MBIT'
            GROUP BY em.year) as tb2, 
            (SELECT em.year, SUM(em.noOfStudent) AS MCB
            FROM tbl_exam_major em, tbl_school s, tbl_major m, tbl_exam e, tlb_department d
            WHERE d.schoolID=s.schoolID AND m.deptID=d.deptID AND em.majorID=m.majorID AND
            em.year=e.year AND em.semester=e.semester AND e.slot=em.slot AND
            em.year>'2013 ' AND s.schoolID='IUB_SHSLS' AND d.deptID='IUB_DSLS' AND m.majorID='IUB_MMCB'
            GROUP BY em.year) as tb3,
            tbl_exam_major em
            where tb1.year = tb2.year and tb2.year = tb3.year
            GROUP BY tb1.year
